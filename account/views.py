...
def add_to_wishlist(request, id):
    ...
    if product.users_wishlist.filter(id=request.user.id).exists():
        ...
        messages.success(request, product.title + " has been removed from ")
    else:
...
@login_required
# folosim @ (decoratorul login_required pt ca view ul sa poata fi folosit doar atunci cand utilizatorul este logat)
